...
def process_text(text):
    summary = process_query("Write a summary from the given text: ", text)
    key_points = process_query("Write out some key points from the given text: ", text)
    return {
        "summary": summary,
        "key_points": [
            key_points
...
def main(pdf_path, json_file_path):
